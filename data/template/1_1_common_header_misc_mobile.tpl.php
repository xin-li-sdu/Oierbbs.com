...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1531804949, '1', './data/template/1_1_common_header_misc_mobile.tpl.php', './template/default', 'common/header_misc_mobile')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1531804949, '1', './data/template/1_1_common_header_misc_mobile.tpl.php', './template/default', 'common/header_misc_mobile')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1531804949, '1', './data/template/1_1_common_header_misc_mobile.tpl.php', './template/default', 'common/header_misc_mobile')
;?>
