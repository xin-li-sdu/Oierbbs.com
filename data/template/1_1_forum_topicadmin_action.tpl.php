...
<tr>
<th>作者所得</th>
<td><?php echo $payment['income'];?> <?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title'];?></td>
</tr>
</table>
...
<ul id="reasonselect" style="display: none"><?php echo modreasonselect(); ?></ul>
    ...
    <?php if($_GET['action'] == 'delpost' && $_G['group']['allowbanuser']) { ?>
        <div class="c">
            <div class="tpclg">
            <h4 class="cl">
                <p class="y">
