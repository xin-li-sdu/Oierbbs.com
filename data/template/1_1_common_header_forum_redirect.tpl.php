...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1530715677, '1', './data/template/1_1_common_header_forum_redirect.tpl.php', './template/default', 'common/header_forum_redirect')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1530715677, '1', './data/template/1_1_common_header_forum_redirect.tpl.php', './template/default', 'common/header_forum_redirect')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1530715677, '1', './data/template/1_1_common_header_forum_redirect.tpl.php', './template/default', 'common/header_forum_redirect')
;?>
